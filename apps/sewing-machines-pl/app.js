...
const MODELS = [
  ...
  {name:"Minerva HS1000", price:954, press:1, hook:"rotacyjny", weight:6.9, power:100, spm:850, stitches:34, rating:4.6, opinions:"4,6/5 (Allegro 32)", note:"Pełny metal, silnik servo 100 W, 7-punktowy transport, dziurka 1-stopn., ścieg do 6 mm, stopka pływająca w zestawie. Model z ~2022 r.; konstrukcja projektowana przez Janome, produkcja Chiny/Wietnam; serwis PL: Wrocław."},
  {name:"Janome 1522", price:855, press:1, hook:"wahadłowy", weight:6.5, power:60, spm:860, stitches:25, rating:4.9, opinions:"4,9/5 (Ceneo 43)", note:"Podbudowa HD, przestrzeń robocza 10,5×11 cm (rekord), stopy Matic; od 855 zł (Dark Grey), Light Grey 900 zł. Model jubileuszowy z 2021 r. (100-lecie Janome) — pełna lista części w service manualu producenta.", best:true},
